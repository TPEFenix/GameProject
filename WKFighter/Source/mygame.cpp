...
#pragma region DebugValueable
	...
	void CGameStateInit::DebugmodeLoading()
	{
		if (DebugMode)
		{
			...
			DEMOMASK = BitmapPicture("Content\\Bitmaps\\SCREENMASK.bmp", 800, 0, true, false, false);
			BK.LoadTexture(TransparentColor);
			DEMOMASK.LoadTexture(RGB(0,0,0));
